...
<c:if test="${sessionScope.xoperator.opMark=='Y'}">
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="OperatorServlet?action=modify" style="margin-top:5px" onsubmit="return on_submit()">
      <input type="hidden" name="id1" size="20" value="${xo.opId}" readonly>
      <p>&nbsp;登&nbsp;陆&nbsp;名&nbsp;&nbsp;：<input type="text" name="name1" size="20" value="${xo.opName}"></p>
      <p>&nbsp;新&nbsp;密&nbsp;码&nbsp;&nbsp;：<input type="password" name="password" id="pwd1" size="20"></p>
      <p>&nbsp;再次确认&nbsp;：<input type="password" name="password2" id="pwd2" size="20"></p>
      <p>&nbsp;是否管理员：<input type="radio" value="Y" ${xo.opMark=="Y"?"checked":""} name="state1">是&nbsp;&nbsp;&nbsp;
        <input type="radio" name="state1" value="N" ${xo.opMark=="N"?"checked":""}>否</p>
