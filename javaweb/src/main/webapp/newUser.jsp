...
<c:if test="${sessionScope.xoperator.opMark=='Y'}">
        ...
        <TR vAlign=top>
            <TD height="600" bgColor=#f1f3f9>
                ...
                <form method="POST" action="NewUserServlet" style="margin-top:5px">
                    <input type="hidden" name="action" value="addUser">
                    <input type="hidden" name="cusId" value="${xCustomer.cusId}">
                    <p>&nbsp;手机号码：<input type="number" name="mobileNum" size="20" required></p>
                    <p>&nbsp;漫游状态：<input type="radio" name="userStatus" value="P" checked>省内漫游 <input type="radio" name="userStatus" value="C">国内漫游
                        <input type="radio" name="userStatus" value="I">国际漫游</p>
                    <p>&nbsp;通话级别：<input type="radio" value="L" checked name="userLevel">本地通话
                        <input type="radio" name="userLevel" value="C">国内长途 <input type="radio" name="userLevel" value="I">国际长途</p>
                    <p>&nbsp;客&nbsp;户&nbsp;&nbsp;名：<input type="text" name="cusName" size="20" value="${xCustomer.cusName}" readonly></p>
